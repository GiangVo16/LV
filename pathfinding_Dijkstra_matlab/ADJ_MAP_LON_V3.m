...
A = readmatrix("grid_map_450x300.txt");   % Đọc ma trận
...
esp = udpport("datagram", "IPV4", LocalHost="192.168.1.6", LocalPort=4321);
esp_ip = "192.168.1.7";  % Địa chỉ ESP32
esp_port = 1234;
